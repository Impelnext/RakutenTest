/**
 * @File Name          : RequestInlineReductionMutualAidCmpController.js
 * @Description        : 
 * @Author             : SRM
 * @Group              : 
 * @Last Modified By   : SRM
 * @Last Modified On   : 12/23/2019, 12:57:30 PM
 * @Modification Log   : 
 * Ver       Date            Author      		    Modification
 * 1.0    12/23/2019   SRM     Initial Version
**/
({
    saveInlineRequestReductionMutualAid : function(cmp, event, helper) {
