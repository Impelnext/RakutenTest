({
    init : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {                
                ...
                component.set("v.SupportContentsStatusPLValues", RequestConFields);
                 }
            else if(state === "ERROR"){
    ...
    saveCancellationEmail : function(cmp, event,helper) {
        var params = event.getParam('arguments');
        var obj = params.parentNewRequest;
        obj.SupportContents__c=cmp.get("v.innerCmpNewRequest").SupportContents__c;
