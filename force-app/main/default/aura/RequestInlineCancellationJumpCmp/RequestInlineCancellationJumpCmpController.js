({
	saveInlineCancellationJump : function(cmp, event, helper) {
		...
		obj.CancellationApprovalInvoiceAddress__c= cmp.get("v.innerCmpNewRequest").CancellationApprovalInvoiceAddress__c;
