        ...
        action.setCallback(this,function(response){
            ...
            if (state === "SUCCESS") {                 
				...
				if(component.get("v.getAreaInfoMap").prefecture != ''){
                    component.set("v.innerCmpNewRequest.Prefectures__c", component.get("v.getAreaInfoMap").prefecture);
                }
                if(component.get("v.getAreaInfoMap").municipality != ''){  
                    component.set("v.innerCmpNewRequest.City__c", component.get("v.getAreaInfoMap").municipality);
                }      
                if(component.get("v.getAreaInfoMap").chome != ''){
                    component.set("v.innerCmpNewRequest.Address1__c", component.get("v.getAreaInfoMap").chome);
                }
            }else if(state === "ERROR"){
