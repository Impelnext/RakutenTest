({
    saveRequestInlineUpdateChange : function(cmp, event) {
        ...
        obj.PayChange__c=cmp.get("v.innerCmpNewRequest").PayChange__c;
		obj.MicroChipAttached__c=cmp.get("v.innerCmpNewRequest").MicroChipAttached__c;
		obj.MicrochipNumber__c=cmp.get("v.innerCmpNewRequest").MicrochipNumber__c;
	...
	init : function(component,event,helper){
		...
		helper.getPayChangePicklist(component, event);
        ...
        component.set("v.innerCmpNewRequest.PayChange__c",'無');
