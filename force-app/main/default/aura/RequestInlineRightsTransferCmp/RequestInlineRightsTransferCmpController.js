({
	saveInlineRightsTransferCmp : function(cmp, event, helper) {
		...
		obj.RelationshipChangedContractor__c= cmp.get("v.innerCmpNewRequest").RelationshipChangedContractor__c;
    ...
    init : function(component,event,helper){
		...
		helper.getrelationshipChngContractPicklist(component, event);
