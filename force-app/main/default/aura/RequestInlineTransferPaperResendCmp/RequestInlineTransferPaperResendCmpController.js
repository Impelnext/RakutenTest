({
	saveInlineTransferPaperResend : function(cmp, event, helper) {
        ...
        obj.RetransmissionReason__c = cmp.get("v.innerCmpNewRequest").RetransmissionReason__c;		
        ...
        obj.ResendingDocumentPaymentSlip__c = cmp.get("v.innerCmpNewRequest").ResendingDocumentPaymentSlip__c;
        obj.ResendingDocumentPaymentNumber__c = cmp.get("v.innerCmpNewRequest").ResendingDocumentPaymentNumber__c;
		//obj.Notices__c = cmp.get("v.innerCmpNewRequest").Notices__c;
		obj.ResendingDocumentsProcedures__c = cmp.get("v.innerCmpNewRequest").ResendingDocumentsProcedures__c;
	},
	...
	init : function(component,event,helper){
        ...
        helper.getResendingDocumentsProceduresPicklist(component, event);
		helper.getRetransmissionReasonPicklist(component, event, dependantSubject);	
