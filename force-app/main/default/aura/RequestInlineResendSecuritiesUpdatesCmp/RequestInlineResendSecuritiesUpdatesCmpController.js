({
	saveInlineResendSecuritiesUpdates : function(cmp, event, helper) {
        ...
        obj.ResendDocuments__c = cmp.get("v.innerCmpNewRequest").ResendDocuments__c;
    ...
    init : function(component,event,helper){
		...
		console.log(dependantSubject);
		helper.getRetransmissionReasonPicklist(component, event, dependantSubject);
		helper.getResendDocumentsPicklist(component, event);
