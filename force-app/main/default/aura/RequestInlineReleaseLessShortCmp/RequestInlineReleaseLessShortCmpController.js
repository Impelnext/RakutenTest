({
	saveInlineReleaseLessShortCmp : function(cmp, event, helper) {
        ...
        obj.CancellationType__c = cmp.get("v.innerCmpNewRequest").CancellationType__c;		
		obj.CancellationDocumentsRequired__c = cmp.get("v.innerCmpNewRequest").CancellationDocumentsRequired__c;
		obj.Memo__c = cmp.get("v.innerCmpNewRequest").Memo__c;
		obj.PetDeathDate__c = cmp.get("v.innerCmpNewRequest").PetDeathDate__c;
		obj.PetDeathDateConfirmation__c = cmp.get("v.innerCmpNewRequest").PetDeathDateConfirmation__c;
		obj.RefundUponCancellation__c = cmp.get("v.innerCmpNewRequest").RefundUponCancellation__c;		
	...
	init : function(component,event,helper){
		...
		helper.getcancellationTypePicklist(component, event);
		helper.getMemoPicklist(component, event,dependantSubject);
		helper.getpetDeathDateConfirmationPicklist(component, event);
		helper.getrefundUponCancellationPicklist(component, event);
