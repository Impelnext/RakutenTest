({
    saveInlineRequestAlphaReplacement : function(cmp, event, helper) {
        ...
        obj.Previous__c = cmp.get("v.innerCmpNewRequest").Previous__c;
        obj.Later__c = cmp.get("v.innerCmpNewRequest").Later__c;
    ...
    init : function(component,event,helper){
        ...
        helper.getPreviousPickList(component, event);
        helper.getLaterPickList(component, event);
